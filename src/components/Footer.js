    ...
    <footer className="mt-28">
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-center">
          <div className="mb-6 md:mb-0 pr-24 w-64">
            <a href="#" className="flex items-center">
              <img src={logoLarge} className="w-full mr-3" alt="FlowBite Logo" />
            </a>
            <p className="mt-6">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            ...
            <div className="hidden lg:block">
              ...
              <ul className="text-gray-500 dark:text-gray-400 font-medium">
                ...
                <li>
                  <div className="custom-search-box w-full">
                    <input placeholder="Enter your email address" type="text" />
                    <button className="grad-btn md-btn w-28">
                      Send
                    </button>
                  </div>
                </li>
        ...
        <div className="block lg:hidden mt-10">
              ...
              <ul className="text-gray-500 dark:text-gray-400 font-medium">
                ...
                <li>
                  <div className="custom-search-box w-full mb-14">
                    <input placeholder="Enter your email address" type="text" />
                    <button className="grad-btn md-btn w-28">
                      Send
                    </button>
        ...
        <div className="flex flex-col-reverse justify-center items-center ">
          ...
          <div className="flex justify-between items-center mb-4">
            <a className="text-slate-500 px-5 hover:underline underline-offset-4" href="">
                Term of Services
            </a>
            <div style={{backgroundColor: 'rgb(52, 56, 76)', width: '1px', height: '32px'}}>
